...
from pipelines.preprocessor.managed_model import preproc_models
...
class MangaLineExtration:
    ...
    def load_model(self):
        preproc_models.load_models()
        modelpath = os.path.join(preproc_models.manga_line_model_dir, "erika.pth")
