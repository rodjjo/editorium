...
from pipelines.omnigen.model import OmniGen
from pipelines.omnigen.scheduler import OmniGenScheduler
from pipelines.omnigen.processor import OmniGenProcessor
...
class OmniGenPipeline:
    def __init__(
        ...
        if device is None:
            if torch.cuda.is_available():
                ...
                print("Don't detect any available GPUs, using CPU instead, this may take long time to generate image!!!")
    ...
    def enable_sequential_cpu_offload(self):
        ...
        self._enable_sequential_cpu_offload(self.model.llm)
    ...
    def from_pretrained(cls, model_name, vae_path: str=None):
        ...
        if os.path.exists(os.path.join(model_name, "vae")):
            ...
            print(f"No VAE found in {model_name}, downloading stabilityai/sdxl-vae from HF")
